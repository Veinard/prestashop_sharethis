...
public function getContent()
  {
		...
		$this->_html .= '<h2>'.$this->displayName.'<span style=" float:right;">Support: <br/> 
		<span style="font-size:14px;">Mail - <em style="font-weight:normal;">seregasakun@gmail.com</em>,  Skype - <em style="font-weight:normal;">sakun_sergey</em></span> </span></h2><div class="clear"></div>';
...
public function hookExtraRight($params)
	...
	function hookTop($params)
	{
		...
		if (Configuration::get('ADDTHISSHARE_FACEBOOK') == 1)
			$data['facebook'] = '<span class="st_facebook_hcount sharebtn" displayText="Facebook"></span>';
		$smarty->assign('addsharethis_data', $data);	
		return $this->display(__FILE__, 'addsharethis_top.tpl');
	}
}
?>